...
def check_phonics_sorting():
    ...
    try:
        with open('textbook_4_4自然拼读.json', 'r', encoding='utf-8') as f:
            data = json.load(f)
    except FileNotFoundError:
        print("❌ 文件不存在: textbook_4_4自然拼读.json")
        return
    ...
    second_level_dirs = [item for item in data if item['parentCode'] == '4' and item['link'] is None]
